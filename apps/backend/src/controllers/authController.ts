...
const generateToken = (res: Response, userId: string): void => {
  try {
    ...
    const cookieOptions = {
      ...
      sameSite: "lax" as const, // Lax is usually better for localhost development cross-port
      path: "/",
    };
...
export const registerUser = async (
  ...
  try {
    console.log(" REACHED BACKEND: /auth/signup");
    ...
    // Fixed the id landmine here by letting Prisma generate it automatically
